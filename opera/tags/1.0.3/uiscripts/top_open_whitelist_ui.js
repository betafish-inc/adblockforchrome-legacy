...
function top_open_whitelist_ui() {
  ...
  load_jquery_ui(function() {
    ...
    // Opera's URLfilter API can't handle $document rules, and our bandaid only
    // works for @@||site.com/* rules, thus without path. (otherwise it'd only
    // work for popups and hiding rules)
    var showPath = false; // !!(location[1]);
