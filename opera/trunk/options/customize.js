...
$(function() {
  ...
  if (chrome.extension.getBackgroundPage().olderOpera) {
    $("#txtBlockUrlDomain, [i18n='opera_linkunblock'], [i18n='show_ads_except_for'], [i18n='stop_blocking_ads'], [i18n='blockdomain']").css("color", "grey").prop("disabled", true).unbind().attr("title", translate("opera_enabledin", "Opera 12.50"));
  }
});